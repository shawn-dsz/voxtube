...
export const config = {
  ...
  maxTranscriptLength: parseInt(process.env.MAX_TRANSCRIPT_LENGTH || '100000', 10),
  cleanupIntervalHours: parseInt(process.env.CLEANUP_INTERVAL_HOURS || '12', 10),
  llmProvider: process.env.LLM_PROVIDER || 'openai_compat',
  llmApiKey: process.env.LLM_API_KEY || '',
  llmBaseUrl: process.env.LLM_BASE_URL || 'https://api.moonshot.ai/v1',
